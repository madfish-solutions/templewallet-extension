...
const privateKeyOfCreatedOrRestoredAccount = getEnv('CREATED_OR_RESTORED_ACCOUNT_PRIVATE_KEY');
...
if (!privateKeyOfCreatedOrRestoredAccount)
  throw new Error('process.env.CREATED_OR_RESTORED_ACCOUNT_PRIVATE_KEY not found.');
...
export class BrowserContext {
  ...
  public static privateKeyOfCreatedOrRestoredAccount = privateKeyOfCreatedOrRestoredAccount;
