...
const PATH_AIRGAP_SAPLING_WASM_DIR = path.join(PATH_NODE_MODULES, '@airgap/sapling-wasm/dist');
...
const PATHS = {
  ...
  AIRGAP_SAPLING_WASM_DIR: PATH_AIRGAP_SAPLING_WASM_DIR,
  HYPELAB_EMBED_FILE: PATH_HYPELAB_EMBED_FILE,
