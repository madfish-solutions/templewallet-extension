...
export const SwapForm: FC = () => {
  ...
  const onSubmit = async () => {
    ...
    const fromRoute3Token = getRoute3TokenBySlug(route3tokens, inputValue.assetSlug);
    const toRoute3Token = getRoute3TokenBySlug(route3tokens, outputValue.assetSlug);
