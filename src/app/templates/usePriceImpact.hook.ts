...
export const usePriceImpact = (
  ...
  const calculatePriceImpactWithDebounce = useMemo(
    () =>
      debouncePromise(
        async (
          ...
          if (
            ...
            const marketPrice = await getMarketPrice(
              tezosParam,
              selectedExchangerParam,
              inputContractAddressParam,
  ...
  useEffect(
    () =>
      void calculatePriceImpactWithDebounce(
        tezos,
        selectedExchanger,
    ...
    [
      calculatePriceImpactWithDebounce,
      tezos,
      selectedExchanger,
      inputContractAddress,
      outputContractAddress,
