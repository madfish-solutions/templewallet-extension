import { Ref, memo, PropsWithChildren, useCallback, useState } from 'react';
...
export interface SimpleInfiniteScrollProps {
  ...
  ref?: Ref<InfiniteScroll>;
}

export const SimpleInfiniteScroll = memo<PropsWithChildren<SimpleInfiniteScrollProps>>(
