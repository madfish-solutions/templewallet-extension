          ...
          <tbody>
            ...
            {fees && (
              <tr>
                <td>Fee</td>
                <td>
                  {toPercentage(pair.type === 'spot' ? fees.userSpotCrossRate : fees.userCrossRate, undefined, 4)}
                </td>
                <td>{toPercentage(pair.type === 'spot' ? fees.userSpotAddRate : fees.userAddRate, undefined, 4)}</td>
              </tr>
            )}
          </tbody>
        </table>
