export enum WithdrawSelectors {
  ...
  aliceBobCancelButton = 'Withdraw AliceBob/Cancel Button',
  aliceBobCancelOrderButton = 'Withdraw AliceBob/Cancel Order Button',
  aliceBobSupportButton = 'Withdraw AliceBob/Support Button'
}
