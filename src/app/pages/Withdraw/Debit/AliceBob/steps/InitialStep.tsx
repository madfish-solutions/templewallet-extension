...
export const InitialStep = memo<Props>(({ publicKeyHash, isApiError, setOrderInfo, setStep, setIsApiError }) => {
  ...
  const { tezBalanceLoading, isMinAmountError, isMaxAmountError, isInsufficientTezBalanceError, disabledProceed } =
    useDisabledProceed(publicKeyHash, inputAmount, outputCurrency?.minAmount, outputCurrency?.maxAmount, true);
