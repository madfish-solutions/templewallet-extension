...
const CurrencyComponent = forwardRef<HTMLDivElement, Props>(({ onPress, label, type }, ref) => {
  return (
    <div
      style={type === 'currencySelector' ? undefined : { margin: '5px 0', justifyContent: 'start', paddingLeft: '5px' }}
      onClick={onPress}
      ref={ref}
