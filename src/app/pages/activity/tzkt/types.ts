 ...
 */
export type TzktOperationType = 'delegation' | 'origination' | 'transaction'
	| 'reveal'
	// | 'endorsement' | 'ballot' | 'proposal' | 'activation'
;

/*
export enum TzktOperationTypeEnum {
	Endorsement = 'endorsement',
	Ballot = 'ballot',
	Proposal = 'proposal',
	Activation = 'activation',
	DoubleBaking = 'double_baking',
	DoubleEndorsing = 'double_endorsing',
	NonceRevelation = 'nonce_revelation',
	Delegation = 'delegation',
	Origination = 'origination',
	Transaction = 'transaction',
	Reveal = 'reveal',
	Migration = 'migration',
	Revelation_penalty = 'revelation_penalty',
	Baking = 'baking',
}
*/
...
export type TzktQuote = Partial<
	Record<TzktQuoteCurrency, number>
>;
...
export type Int32Parameter = Partial<
	Record<Int32ParameterKey, number>
>;
