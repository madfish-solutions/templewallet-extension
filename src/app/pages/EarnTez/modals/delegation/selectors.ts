export enum DelegationModalSelectors {
  sortByButton = 'Delegation modal/Sort by button',
  sortByRank = 'Delegation modal/Sort by rank',
  sortByFee = 'Delegation modal/Sort by fee',
