...
interface DelegationModalProps {
  ...
  onDelegationSuccess?: SyncFn<string>;
  onClose: EmptyFn;
}

type GenericModalProps = EarnOperationModalProps<string | Baker, ReviewData>;

export const DelegationModal = memo<DelegationModalProps>(
  ({ bakerPkh, directBakerPkh, account, network, onDelegationSuccess, onClose }) => {
    ...
    const makeReviewData = useCallback<GenericModalProps['makeReviewData']>(
      ...
      [account, network, onDelegationSuccess]
    );
