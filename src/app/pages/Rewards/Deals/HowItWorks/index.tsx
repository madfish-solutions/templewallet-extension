...
export const RewardsDealsHowItWorks: FC = () => (
  <PageLayout pageTitle={<PageTitle title={t('howItWorksPageTitle')} />} contentPadding={false}>
    <div className="bg-white px-4 flex flex-col">
      <section className="flex flex-col gap-4 items-center pt-4 pb-8">
        ...
        <div className="flex flex-col gap-1 w-full">
          <h3 className="text-font-h3 text-center">{t('howItWorksDealsHeading')}</h3>
          <p className="text-font-description text-grey-1 text-center">{t('howItWorksDealsBody')}</p>
        </div>
      ...
      <section className="flex flex-col gap-3 items-center pt-4 pb-6">
        <div className="flex flex-col gap-1 w-80 mb-3">
          <h3 className="text-font-h3 text-center">{t('howItWorksRewardsHeading')}</h3>
          <p className="text-font-description text-grey-1 text-center">{t('howItWorksRewardsBody')}</p>
        </div>
        <div className="grid grid-cols-2 gap-3 w-full">
          <ExplainerCard Icon={VerifiedIcon} text={t('howItWorksRewardsCard1')} />
          <ExplainerCard Icon={ClockCheckIcon} text={t('howItWorksRewardsCard2')} />
        </div>
        <div className="bg-secondary-low rounded-6 p-3 flex gap-1 w-full">
          ...
          <div className="flex flex-col gap-0.5">
            <p className="text-font-description-bold">{t('howItWorksNoteLabel')}</p>
            <p className="text-font-description">{t('howItWorksNote')}</p>
          </div>
        </div>
      </section>
    </div>
