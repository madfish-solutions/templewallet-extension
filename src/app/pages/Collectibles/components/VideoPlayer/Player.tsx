...
interface Props {
  ...
  onError?: EmptyFn;
  ref?: Ref<HTMLVideoElement | HTMLAudioElement>;
}
...
export const Player: FC<Props> = ({
  ...
  const volumeInputHandler = useCallback((event: ChangeEvent<HTMLInputElement>) => {
    const player = playerRef.current!;
  ...
  const seekMouseMoveHandler = useCallback((event: MouseEvent) => {
    const player = playerRef.current!;
  ...
  const seekInputHandler = useCallback((event: ChangeEvent<HTMLInputElement>) => {
    const player = playerRef.current!;
