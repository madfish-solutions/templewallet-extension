  ...
  return (
    <>
      {details?.attributes.map(attribute => (
        <div
          key={attribute.id}
          className="flex flex-col items-center gap-y-1 p-2 border border-gray-300 rounded-md text-center"
        >
...
export const PropertiesItems: FC<PropertiesItemsProps> = ({ assetSlug, accountPkh, details }) => {
  ...
  const itemValueClassName = 'text-base font-semibold leading-5';
