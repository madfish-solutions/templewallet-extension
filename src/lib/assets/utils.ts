...
export const toChainAssetSlug = (chainId: number | string, assetSlug: string) => `${chainId}$${assetSlug}`;

export const fromChainAssetSlug = <T = string>(slug: string) => slug.split('$') as [chainId: T, assetSlug: string];
