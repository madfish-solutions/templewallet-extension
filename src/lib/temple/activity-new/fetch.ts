import { Activity, ActivityType, parseTransactions, TzktOperationType } from '@temple-wallet/transactions-parser';
 ...
 * > when it's not true!
 */
const buildOlderThanParam = (olderThan?: Activity) => ({ 'timestamp.lt': olderThan?.timestamp });
