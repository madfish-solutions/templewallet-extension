...
export const MERCHANT_OFFERS_ENABLED_STORAGE_KEY = 'MERCHANT_OFFERS_ENABLED';

export const MERCHANT_OFFERS_SNOOZED_UNTIL_STORAGE_KEY = 'MERCHANT_OFFERS_SNOOZED_UNTIL';
