...
export const EnvVars = {
  ...
  MT_PELERIN_ACTIVATION_KEY: process.env.MT_PELERIN_ACTIVATION_KEY!,
  MT_PELERIN_REF_CODE: process.env.MT_PELERIN_REF_CODE!,
  ...
  KOLO_API_PUBLIC_KEY: process.env.KOLO_API_PUBLIC_KEY!,
  KOLO_BASE_URL: process.env.KOLO_BASE_URL!,
  ...
  HYPELAB_EXTERNAL_NATIVE_WIDGET_PLACEMENT_SLUG: process.env.HYPELAB_EXTERNAL_NATIVE_WIDGET_PLACEMENT_SLUG!,
  SPECIFY_PUBLISHER_KEY: process.env.SPECIFY_PUBLISHER_KEY,
