...
export const EnvVars = {
  ...
  TEMPLE_WALLET_KOLO_TEST_API_KEY: process.env.TEMPLE_WALLET_KOLO_TEST_API_KEY!,
  KOLO_TEST_BASE_URL: process.env.KOLO_TEST_BASE_URL!,
  TEMPLE_WALLET_KOLO_API_KEY: process.env.TEMPLE_WALLET_KOLO_API_KEY!,
